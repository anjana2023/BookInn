...
exports.deleteOtp = exports.verifyTokenResetPassword = exports.sendResetVerificationCode = exports.authenticateGoogleOwner = exports.verifyOtpOwner = exports.loginOwner = exports.OwnerRegister = void 0;
...
const sendResetVerificationCode = (email, ownerRepository, authService) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    console.log(verificationCode, "------------------------------vhdsdsdudkygsud----------------------------------verification code");
