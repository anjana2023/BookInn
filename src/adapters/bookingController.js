...
function bookingController(bookingDbRepository, bookingDbRepositoryImp, hotelDbRepository, hotelDbRepositoryImpl, hotelServiceInterface, hotelServiceImpl, userDbRepository, userDbRepositoryImpl) {
    ...
    const updatePaymentStatus = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (paymentStatus === "Paid") {
                ...
                if (bookings) {
                    const dates = yield (0, booking_1.addUnavilableDates)(bookings.rooms, (_e = bookings.checkInDate) !== null && _e !== void 0 ? _e : new Date(), (_f = bookings.checkOutDate) !== null && _f !== void 0 ? _f : new Date(), dbRepositoryHotel, hotelService);
                }
            }
    ...
    const addUnavilableDate = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
        var _g, _h;
        const data = req.body;
        const result = yield (0, booking_1.addUnavilableDates)(data.rooms, (_g = data.checkInDate) !== null && _g !== void 0 ? _g : new Date(), (_h = data.checkOutDate) !== null && _h !== void 0 ? _h : new Date(), dbRepositoryHotel, hotelService);
        res.status(httpStatus_1.HttpStatus.OK).json({
            success: true,
    ...
    const cancelBooking = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (updateBooking) {
                const dates = yield (0, booking_1.removeUnavilableDates)(updateBooking.rooms, (_j = updateBooking.checkInDate) !== null && _j !== void 0 ? _j : new Date(), (_k = updateBooking.checkOutDate) !== null && _k !== void 0 ? _k : new Date(), dbRepositoryHotel, hotelService);
            }
            res.status(httpStatus_1.HttpStatus.OK).json({
                success: true,
