...
const chatRepositoryMongodb = () => {
    const isChatExists = (senderId, recieverId) => __awaiter(void 0, void 0, void 0, function* () { return yield chatModel_1.default.findOne({ members: { $all: [senderId, recieverId] } }); });
    const getConversationById = (id) => __awaiter(void 0, void 0, void 0, function* () { return yield chatModel_1.default.findById(id); });
    const addNewChat = (members) => __awaiter(void 0, void 0, void 0, function* () {
        return yield chatModel_1.default.create({ members });
    });
    const getChatsByMembers = (id) => __awaiter(void 0, void 0, void 0, function* () { return yield chatModel_1.default.find({ members: { $in: [id] } }); });
